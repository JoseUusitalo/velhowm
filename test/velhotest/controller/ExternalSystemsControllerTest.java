...
public class ExternalSystemsControllerTest
{
	...
	public final void testMoveValid()
	{
		...
		// Move is a success.
		assertTrue(ExternalSystemsController.getInstance().receiveMoveCommand(box.getDatabaseID(), NEW_SHELFSLOT_ID, false));
		...
		assertTrue(ExternalSystemsController.getInstance().receiveMoveCommand(box.getDatabaseID(), oldShelfSlot, false));
	...
	{
		assertFalse(ExternalSystemsController.getInstance().receiveMoveCommand(BOX_NOT_IN_SLOT, "S1-1-1", false));
	}

	@Test
	public final void testMoveBackToSameSlot()
	{
		assertFalse(ExternalSystemsController.getInstance().receiveMoveCommand(BOX_DBID_1, "S1-1-1", false));
	}

	@Test
	public final void testMoveInvalidBox()
	{
		assertFalse(ExternalSystemsController.getInstance().receiveMoveCommand(99999, "S4-1-1", false));
	}
	...
	public final void testMoveValid_NotInSlot()
	{
		...
		assertTrue(ExternalSystemsController.getInstance().receiveMoveCommand(box.getDatabaseID(), null, false));
