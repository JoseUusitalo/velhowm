...
public class SampleData
{
	...
	private static void createSample_Products()
	{
		...
		DatabaseController.save(new Product(2, "Lonely Product #2", DatabaseController.getProductBrandByID(1), DatabaseController.getProductCategoryByID(1)));
		...
		DatabaseController.save(new Product(10, "Test Product #10", DatabaseController.getProductBrandByID(3), DatabaseController.getProductCategoryByID(1)));
		DatabaseController.save(new Product(11, "Lonely Product #11", DatabaseController.getProductBrandByID(2), DatabaseController.getProductCategoryByID(4)));
		DatabaseController.save(new Product(12, "Lonely Product #12", DatabaseController.getProductBrandByID(2), DatabaseController.getProductCategoryByID(4)));
	}
